...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="header_and_footer_5.css">
    </head>
        ...
        <div class="main-div">
            ...
            <div class="right-main">
                ...
                <div class="game-area">
                    ...
                    ?>
                        <form style="width: 100%; margin: 0px;" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>?gid=<?php echo $Game_Id ?>&uid=<?php echo $User_Id ?>" method="post">
                            <div class="listnames">
                                <div class="labelList">
                                    ...
                                    <label for="<?php echo $i; ?>">
                                        ...
                                        <div class="Stock-chart">
                                            <a href="<?php echo $Stock_chart_url; ?>"><img src="<?php echo $Stock_chart; ?>" width="30px"></a>
                                        </div>
                                    </label>
                                </div>
    ...
    <script>
        let modal = document.getElementById('notif-content');
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($No_of_playes_available < $Max_Players) {
            if (mysqli_query($connect, "update live_game set Stocks_Selected='$selected_stock',Entering_Position='$Commas2',Players='$Player' where Game_Id =$Game_Id") && mysqli_query($connect, "update users set Live_game='$User_Pos',Coins='$Coins_Left' where User_Id  =$User_Id")) {
                echo ("<script>location.href = 'http://karrotlive.com/nsebse.php';</script>");
            } else {
