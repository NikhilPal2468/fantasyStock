...
server.on('request', (req, res) => {
    switch (req.url) {
        ...
        case "/":
            fs.readFile(path.join(__dirname + '/profile.php'), (err, data) => {
                if (err) {
                    res.writeHead(404)
        ...
        case "/paynow":
            ...
            const orderId = 'KARROT_' + new Date().getTime()
            ...
            req.on('error', (err) => {
                ...
                paytmParams.body = {
                    ...
                    "orderId": orderId,
                    "callbackUrl": "https://karrotlive.com/callback",
                    "txnAmount": {
                        "value": data.amount,
                        "currency": "INR",
                    },
                            ...
                            post_res.on('end', function () {
                                ...
                                res.write(`<html>
                                    ...
                                    <body>
                                        ...
                                        <center>
                                            <div>Amount: ${response.body.txnAmount}</div>
                                            <div>Order Id: ${response.body.orderId}</div>
                                            <div>Bank: ${response.body.bankName}</div>
                                        </center>
