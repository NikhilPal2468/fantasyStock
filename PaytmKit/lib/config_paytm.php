...
// define('PAYTM_MERCHANT_KEY', 'G@79w9_KULQcS9YD'); //Change this constant's value with Merchant key received from Paytm.
// define('PAYTM_MERCHANT_MID', 'tAJfFn99840682749020'); //Change this constant's value with MID (Merchant ID) received from Paytm.
...
if (PAYTM_ENVIRONMENT == 'PROD') {
	...
	$PAYTM_MERCHANT_MID 		= "tAJfFn99840682749020";
	$PAYTM_MERCHANT_KEY 		= "G@79w9_KULQcS9YD";
	...
	$PAYTM_CALLBACK_URL 	= "https://karrotlive.com/nsebse.php";
